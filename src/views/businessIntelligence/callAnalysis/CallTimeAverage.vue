  ...
  <div v-loading="loading">
    ...
    <div class="main-container">
      <div class="content">
        <h4 class="axis-title">
          平均通话时长
          <el-tooltip class="item" effect="dark" content="平均通话时长：通话总时长/通话总次数" placement="top">
...
import { queryCallChart, queryCallChartDetail } from '@/api/businessIntelligence/calling'
...
export default {
  ...
  methods: {
     ...
     */
    searchClick(params) {
      this.postParams = { ...params, action: 'averageDuration' }
      this.getDataList()
      this.getRecordList()
    },
    /**
