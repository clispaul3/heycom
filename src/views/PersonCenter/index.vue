  ...
  <div v-loading="loading">
    ...
    <el-card>
      <div class="header-handle">
        <el-button
          type="primary"
          @click="editClick('password')" style="display: none;">修改密码</el-button>
        <el-button
          type="primary"
...
<script>
import { adminUsersUpdate, adminUsersUpdateImg } from '@/api/personCenter/personCenter'
...
export default {
  ...
  methods: {
    ...
    submiteImage(data) {
      this.loading = true
      uploadFile(data.file, 'avatar').then(res => {
          if(res.code === 0){
            adminUsersUpdate({ img: res.data.filepath }).then(res => {
              if (res.code === 0) {
                this.loading = false
                this.getDetail()
              }
