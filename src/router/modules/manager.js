  ...
  children: [
    {
      path: 'custom-field',
      component: () =>
        import('@/views/SystemManagement/SystemCustomer/customField'),
      meta: {
        title: '自定义字段设置',
        requiresAuth: true,
        index: 2,
    ...
    },
    {
      path: 'customer',
      component: () =>
        import('@/views/SystemManagement/SystemCustomer/customer'),
      meta: {
        title: '客户公海规则设置',
        requiresAuth: true,
        index: 2,
    ...
    },
    {
      path: 'biz-param',
      component: () =>
        import('@/views/SystemManagement/SystemCustomer/bizParam'),
      meta: {
        title: '业务参数设置',
        requiresAuth: true,
        index: 2,
    ...
    },
    {
      path: 'biz-goals',
      component: () =>
        import('@/views/SystemManagement/SystemCustomer/bizGoals'),
      meta: {
        title: '业绩目标设置',
        requiresAuth: true,
        index: 2,
...
const systemEmployeeRouter = {
  ...
  children: [
    ...
    },
    {
      ...
      path: 'systemidentification', // 企业认证
      component: () =>
        import('@/views/SystemManagement/SystemIdentification/index'),
      meta: {
        requiresAuth: false,
        title: '企业认证',
        icon: 'check',
    ...
    },
    {
      ...
      component: () =>
        import('@/views/SystemManagement/SystemEmployee/EmployeeDepManagement'),
      meta: {
        requiresAuth: true,
        title: '员工与部门管理',
        icon: 'department',
  ...
  children: [
    {
      ...
      path: 'system-examine',
      component: () =>
        import('@/views/SystemManagement/SystemExamine/SystemExamine'),
      meta: {
        requiresAuth: true,
        title: '审批流程管理',
        icon: 'examine',
...
const handlefieldRouter = {
  ...
  component: () =>
    import('@/views/SystemManagement/SystemCustomer/HandleField'),
  meta: {
...
const outboundNumberRouter = {
  path: 'outbound-number/index/:status',
  name: 'outboundNumber',
  meta: {
    requiresAuth: false,
    title: '外呼号码管理',
  ...
  children: [
    {
      name: 'onUnrRreviewed',
      path: 'outbound-number/index/0',
      component: () => import('@/views/SystemManagement/outboundNumber/index'),
      meta: {
        requiresAuth: true,
        title: '待审外呼号码',
        index: 2,
        type: 'manage',
        subType: ['call', 'pending']
      }
    },
    {
      name: 'onList',
      path: 'outbound-number/index/1', //全部外呼电话
      component: () => import('@/views/SystemManagement/outboundNumber/index'),
      meta: {
        requiresAuth: true,
        title: '全部外呼号码',
